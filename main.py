...
async def cmd_ai(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    msg = await update.message.reply_text("🔎 Recherche d'informations...")
    results = await web_search.search(question, max_results=4)
    try:
        await msg.edit_text("🧠 Réflexion en cours...")
    except Exception:
        pass
    answer = await ai_assistant.answer_with_context(question, results)

    ...
    async def ask(self, question: str, max_tokens: int = 2048) -> str:
        ...
        payload = {
            ...
            "generationConfig": {
                ...
                # Réponses courtes de type chatbot: pas besoin d'un raisonnement
                # poussé, et ça évite que le budget de tokens parte dans la
                # "réflexion" interne au lieu de la réponse visible.
